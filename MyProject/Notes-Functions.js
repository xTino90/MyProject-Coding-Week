...
BONUS: Use the 'displayResults' method to display the 2 arrays in the test data.
 Use both the 'array' and the 'string' option. Do NOT put the arrays in the poll object! So what shoud the this
...
const poll = {
  ...
  registerNewAnswer() {
    ...
    if (
      ...
      // Update the answer
      this.answers[selectedOption] = (this.answers[selectedOption] || 0) + 1;
